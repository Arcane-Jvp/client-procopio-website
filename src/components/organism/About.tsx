      ...
      <div className="flex max-lg:items-center max-lg:justify-center flex-col-reverse lg:grid grid-cols-8 gap-4">
        ...
        <div className="w-full bg-foreground rounded-xl p-4 sm:p-6 space-y-3 sm:space-y-6 col-span-4">
          ...
          <dl className="grid grid-cols-1 sm:grid-cols-4 gap-3 sm:gap-2">
            <dt className="font-title text-xl sm:text-2xl col-span-1 text-start w-full">
              Design gráfico
            </dt>
            <dd className="text-lg sm:text-xl col-span-3">
              Planejamento, desenvolvimento e execução de estratégias para
              aumentar a produtividade em redes sociais, incluindo criação de
              posts e artes para campanhas.
            </dd>
            ...
            <dd className="text-lg sm:text-xl col-span-3">
              Gestão e criação de peças gráficas com foco em transmitir a
              mensagem do cliente da forma mais clara e eficaz possível.
            </dd>
            ...
            <dd className="text-lg sm:text-xl col-span-3">
              Planejamento e criação de protótipos para sites e aplicativos, com
              foco em aproximar marcas e público por meio de experiências
              intuitivas.
            </dd>
          </dl>
        </div>

...
export default function Footer() {
  ...
  return (
    <footer
      ...
      role="contentinfo"
      aria-label="Rodapé"
      className="bg-accent grid grid-cols-6 py-11 md:py-20 overflow-y-hidden relative"
    >
      <div
        aria-hidden="true"
          ...
          <nav aria-label="Redes sociais" className="max-md:-mt-1 md:pt-2">
            <ul className="flex items-center justify-center gap-8 md:gap-4.5 md:justify-start">
              <li>
                ...
                >
                  <svg viewBox="0 0 35 35" xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 md:h-7 md:w-7" aria-hidden="true">
              ...
              <li>
                <a
                  ...
                  className="flex items-center justify-center rounded-sm text-accent-muted hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-accent-muted"
                >
                  <svg viewBox="0 0 43 35" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 md:h-8 md:w-8" aria-hidden="true">
